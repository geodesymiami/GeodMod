function [X,Y]= discalc(disgeom) 
%   discalc        - Calculates surface projection of the dislocation 
...
%
%      Output: LowerLeft,LowerRight,UpperLeft,UpperRight 
%
...
X = [real(ll), real(lr) , real(ul) , real(ur)] ;
Y = [imag(ll), imag(lr) , imag(ul) , imag(ur)] ;
