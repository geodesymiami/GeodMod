function [xy_out] = ll2local(xy,data,direc)
%local2utm              - convert from local (disloc) coordinate system into ll 
%
% INPUT: 
%       xy 	             - coordinate vector (2xN)  
%       igram            - datastructure with information on x_first, etc
%       dir              - direction (1: ll->local; -1: local->ll)          (default: 1)
%
% OUTPUT:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Following the simplified ll2local conversion in Dem2Basemap.m, the conversion is done using the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if direc==1                                       % from ll to local 
   x_new      = (xy(1,:)-x_first)*x_unitdist ;
   y_new      = (xy(2,:)-y_last)*y_unitdist  ;
   xy_out     = [x_new;y_new];
elseif direc==-1                                       % from local to ll %%Not yet implemented
