function  displot_surfaceintersection(disgeom) 
%   displot        - Plots intersection of dislocation with surface .
...
par     = Extend2Surface(disgeom); 
par(2)  = 0;
disgeom = par; 
% the following is identical with displot
...
%
plot( [real(ll), real(lr)], [imag(ll), imag(lr)],'g' ), axis('equal');
